          ...
          <div className='product-comment'>
            ...
            <div className='product-comment-container'>
              ...
              <div className='product-comment-input'>
                <Stars2 />
                <textarea placeholder='Push a comment' value={pcommentInput} onChange={evt => setPcommentInput(evt.target.value)} type="text" />
                <button onClick={addPcomment}>Send</button>
              </div>
            </div>
          </div>
