...
import './Popup.css'
const PopupFailChat1 = ({ setIsOpenPopupFailChat1 }) => {
  return (
    <div
      onClick={setIsOpenPopupFailChat1.bind(this, false)}
      style={{
        position: "fixed",
      ...
      >
        ...
        <div className="popup-fail-container">
          ...
          <div className="popup-text">
            <p>You need to sign in to send message</p>

          </div>
          <div className="popup-button">
            <button onClick={setIsOpenPopupFailChat1.bind(this, false)}>
              Ok
            </button>
          </div>
        </div>
