...
import './Popup.css'
const PopupFailLogIn2 = ({ setIsOpenPopupFail2 }) => {
  return (
    <div
      onClick={setIsOpenPopupFail2.bind(this, false)}
      style={{
        position: "fixed",
      ...
      >
        ...
        <div className="popup-fail-container">
          ...
          <div className="popup-button">
            <button onClick={setIsOpenPopupFail2.bind(this, false)}>
              Ok
            </button>
          </div>
        </div>
...
export default PopupFailLogIn2;
