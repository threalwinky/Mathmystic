...
import './Popup.css'
const PopupFailLogIn1 = ({ setIsOpenPopupFail1 }) => {
  return (
    <div
      onClick={setIsOpenPopupFail1.bind(this, false)}
      style={{
        position: "fixed",
      ...
      >
        ...
        <div className="popup-fail-container">
          ...
          <div className="popup-text">
            <p>You have entered wrong password</p>

          </div>
          <div className="popup-button">
            <button onClick={setIsOpenPopupFail1.bind(this, false)}>
              Ok
            </button>
          </div>
        </div>
...
export default PopupFailLogIn1;
