...
import './Popup.css'
const PopupFailSignUp2 = ({ setIsOpenPopupFailSignUp2 }) => {
  return (
    <div
      onClick={setIsOpenPopupFailSignUp2.bind(this, false)}
      style={{
        position: "fixed",
      ...
      >
        ...
        <div className="popup-fail-container">
          ...
          <div className="popup-text">
            <p>The email have been taken to sign up</p>

          </div>
          <div className="popup-button">
            <button onClick={setIsOpenPopupFailSignUp2.bind(this, false)}>
              Ok
            </button>
          </div>
        </div>
...
export default PopupFailSignUp2;
